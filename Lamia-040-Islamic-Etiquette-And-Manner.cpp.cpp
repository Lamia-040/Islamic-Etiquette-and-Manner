...
void learnEtiquette() {
    string topics[] = {"Say 'Assalamu Alaikum'.", "Be kind to your parents and elders.", "Keep yourself and your surroundings clean."};
    int choice;
    cout << "1. Greetings\n2. Respect\n3. Cleanliness\nChoose: ";
...
void takeQuiz() {
    ...
    string questions[][2] = {{"Saying 'Assalamu Alaikum' is recommended ? (1=Yes, 2=No): ", "1"},
                             {"Cleanliness is unimportant? (1=Yes, 2=No): ", "2"},
                             {"Should we respect our parents? (1=Yes, 2=No): ", "1"}};
